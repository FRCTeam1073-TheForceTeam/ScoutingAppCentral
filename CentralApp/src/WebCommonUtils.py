...
def get_html_head(title_str = 'FIRST Team 1073 - The Force Team'):
    ...
    head_str += '<link rel="shortcut icon" href="/static/images/favicon.ico" type="image/x-icon" />'
    head_str += '<link rel="stylesheet" href="/static/css/style.css" type="text/css" media="screen" />'
